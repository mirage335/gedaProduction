...
echo -en '\E[1;32;46m Regenerating oshpark specifications... \E[0m'
...
#Regerenate oshpark-compatible gerber packages.
find . -name generate-stencils.sh -type f -exec bash -c 'cd $(dirname $(realpath {})) ; ./generate-gerbers.sh' \; > /dev/null
